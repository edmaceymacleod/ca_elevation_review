...
- [`docs/sessions/`](docs/sessions/README.md) -- the cross-session record format: dated, durable notes for multi-step or risky changes (what changed, how verified, how to undo). First record: the [2026-06-30 write-back disk-persistence validation](docs/sessions/2026-06-30-writeback-disk-persistence-cycle.md).
